...
int push(Stack *which_stack, void *ptr)
{
    ...
    // Had to make greater than or equal to otherwise it would overflow 
    // the max elements allowed.
...
void* pop(Stack *which_stack)
{
    ...
    // Had to make less than or equal to otherwise it would underflow
    // the max elements allowed.
